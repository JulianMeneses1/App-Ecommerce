            ...
            <div className="container-fluid my-4"> 
                ...
                <div id={category} className="carousel carousel-dark slide d-none d-sm-block" data-bs-ride="true">
                    ...
                    <div className="carousel-inner">
                        ...
                        <button className={`carousel-control-prev ${styles.carouselControlPrev}`} type="button" data-bs-target={`#${category}`} data-bs-slide="prev">
                            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span className="visually-hidden">Previous</span>
                        </button>
                        <button className={`carousel-control-next ${styles.carouselControlNext}`} type="button" data-bs-target={`#${category}`} data-bs-slide="next">
