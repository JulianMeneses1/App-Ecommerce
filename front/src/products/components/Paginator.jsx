            ...
            { paginator?.totalPages == 1 || 
                <ul className="pagination">
                    <li className={paginator.first ? 'page-item disabled': 'page-item'}>
                        <Link title="Primer página" className="page-link" to={`${url}0`}>
                    ...
                    { paginator.number == 0 || 
                        <li className="page-item">
                            <Link title="Anterior" className="page-link" to={`${url}${paginator.number-1}`}>
                    ...
                    { paginator.number >= paginator.totalPages - 1 || 
                        <li className="page-item">
                            <Link title="Siguiente" className="page-link" to={`${url}${paginator.number+1}`}>
                    ...
                    <li className={paginator.last ? 'page-item disabled': 'page-item'}>
                        <Link title="Última página" className="page-link" to={`${url}${paginator.totalPages - 1}`}>
